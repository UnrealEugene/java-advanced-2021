...
public class Walk {
            ...
            try (BufferedWriter writer = Files.newBufferedWriter(outputPath)) {
                ...
                while (true) {
                    ...
                    if (path.toFile().isFile()) {
                        ...
                        int read;
                        try (BufferedInputStream byteStream = new BufferedInputStream(Files.newInputStream(path))) {
    ...
    public static void main(String[] args) {
        if (args == null || args.length != 2 || Arrays.asList(args).contains(null)) {
            System.out.println("Usage: Walk <input file> <output file>");
            return;
        }
